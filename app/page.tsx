        ...
        <main className="w-auto min-h-screen p-5">
            <div className='flex flex-col max-w-3xl mx-auto space-y-6'>
                ...
                <nav className='space-x-12 py-8 text-sm'>
                    <a href="/">Home</a>
                    <a href="/projects" className="text-stone-500 hover:text-stone-300 transition-all">Projects</a>
                </nav>
                ...
                <section className="gap-6 flex flex-row">
                    ...
                    <div className='flex flex-col justify-evenly'>
                        ...
                        <div className='flex flex-row gap-5'>
                            ...
                            {/* github link */}
                            <a href="https://github.com/GlassAOTU/" target="_blank">
                            ...
                            {/* linkedin link */}
                            <a href="https://www.linkedin.com/in/abaseen-khan/" target="_blank">
                            ...
                            {/* twitter link */}
                            <a href="https://x.com/aotudev" target="_blank">
                ...
                <section className='flex flex-col gap-4'>
                    ...
                    <p>
                        ...
                        You can reach me at <a href="mailto:arbaseen@gmail.com" className='underline'>arbaseen@gmail.com</a> or through my socials if something I’m working on lines up with what you’re building.
                    </p>
                    ...
                    <div className='text-sm flex gap-6'>
                        ...
                        <div className='flex flex-row gap-2'>
                            <a href="/resume.pdf" rel="noopener noreferrer" target="_blank" className='outline px-6 py-2 rounded-md outline-stone-700 hover:bg-stone-300 hover:text-stone-700 transition-all flex items-center gap-2'>
                            ...
                            <a href="/resume.pdf" download className='outline px-3 py-2 rounded-md outline-stone-700 hover:bg-stone-300 hover:text-stone-700 transition-all flex items-center gap-2'>
                        ...
                        {/* projects button */}
                        <a href="/projects" className='outline px-6 py-2 rounded-md outline-stone-700 hover:bg-stone-300 hover:text-stone-700 transition-all flex items-center gap-2'>
                            Projects
